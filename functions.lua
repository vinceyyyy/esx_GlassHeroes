...
function pedGoToCar(targetVehicle)
    removePedProperties(ped)
    TaskGoToEntity(ped, targetVehicle, -1, 0.25, 1.0, 0, 0)
    return true, ped
end

function pedRepairVehicle(targetVeh)
